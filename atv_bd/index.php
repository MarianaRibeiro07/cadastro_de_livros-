...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        echo "<tr>
                ...
                <td>".$row["ano"]."</td>
                <td>
                    <a class='editar' href='update.php?id=" . $row["id"] . "' title='Editar'>
                <i class='fa-solid fa-pen-to-square'></i>
            </a>
            <a class='excluir' href='delete.php?id=" . $row["id"] . "' title='Excluir'>
...
echo "<br><h4>Total de livros cadastrados: </h4>" . $linhaCount['total'] . "<br>";
